...
function preload() {
    ...
    game.load.image('background','assets/maze/tests/debug-grid-1920x1920.png');
    game.load.image('player','assets/maze/sprites/phaser-dude.png');
    game.load.image('horiz','assets/maze/tests/horizWall.png');
    game.load.image('vert','assets/maze/tests/vertWall.png');
}
