...
function getName() {
    ...
    var matchquotes = /"/;
    if (matchquotes.test(charName)) {
        $("#error").removeClass("hidden");
        $("#errormessage").text("You can't have quotes in your name, since there are already quotes at the end of the line, and your additional quotes will conflict.");
    } else {
